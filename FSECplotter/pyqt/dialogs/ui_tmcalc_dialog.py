...
class Ui_TmCalcDialog(object):
    def setupUi(self, TmCalcDialog):
        ...
        self.treeWidget.header().setDefaultSectionSize(280)
        self.treeWidget.header().setMinimumSectionSize(280)
    ...
    def retranslateUi(self, TmCalcDialog):
        ...
        self.treeWidget.headerItem().setText(1, _translate("TmCalcDialog", "Temperature"))
